...
import 'package:homestay_raya/views/newprodectscreen.dart';
                              ...
                              child: Column(children: [
                                ...
                                Flexible(
                                  ...
                                  child: CachedNetworkImage(
                                    ...
                                    fit: BoxFit.cover,
                                    imageUrl:
                                        "http://10.31.162.218/home_stay_raya/assets/productimages/${productList[index].productId}.png",
...
//check permission,get location,get address return false if any problem.
  ...
  void _loadProducts() {
    ...
    http
        .get(
      Uri.parse(
          "http://10.31.162.218/home_stay_raya/php/loadsellerproducts.php?userid=${widget.user.id}"),
    )
        .then((response) {
