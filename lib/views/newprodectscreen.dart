...
class _NewProductScreenState extends State<NewProductScreen> {
                ...
                child: Column(children: [
                  ...
                  TextFormField(
                      ...
                      validator: (val) => val!.isEmpty || (val.length < 10)
                          ? "Home stay description must be longer than 10 characters"
                          : null,
                      maxLines: 4,
                      keyboardType: TextInputType.text,
                      decoration: const InputDecoration(
                    ...
                    children: [
                      ...
                      Flexible(
                        ...
                        child: TextFormField(
                            ...
                            enabled: false,
                            validator: (val) => val!.isEmpty || (val.length < 3)
                                ? "Home stay State Locality"
                                : null,
                            controller: _prlocalEditingController,
                            keyboardType: TextInputType.text,
                            decoration: const InputDecoration(
                                labelText: 'Home stay State Locality',
                                labelStyle: TextStyle(),
                                icon: Icon(Icons.map),
                                focusedBorder: OutlineInputBorder(
                                  borderSide: BorderSide(width: 2.0),
  ...
  void _newProductDialog() {
    if (_image == null) {
      Fluttertoast.showToast(
          msg: "Please take picture of your Home stay",
  ...
  void insertProduct() {
    ...
    http.post(
        Uri.parse("http://10.31.162.218/home_stay_raya/php/insert_product.php"),
        body: {
